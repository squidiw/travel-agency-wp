...
<header class="packages-header">
        <div class="jumbotron jumbotron-fluid packages-jumbo">
            <div class="container">
                <h1 class="display-3 typed-words" >Travel packages</h1>
           ...
           <div class="row">
               <div class="col-md-9">
                   <div class="tour-package__caption">
                       <h2 class="capitalized pt-3">Lorem ipsum dolor sit amet.
                           <span class="stars">
                   ...
                   <div class="tour-package__description">
                        ...
                        <p >Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi voluptates rerum modi doloribus saepe amet nulla reprehenderit. Laboriosam alias, repudiandae consequuntur sed reiciendis, necessitatibus modi, fugit rerum aspernatur explicabo inventore!</p>
                   </div>

                   <div class="tour-package__banner">
                       <img src="<?php bloginfo('stylesheet_directory') ?>/assets/imgs/face-s.jpg" alt="" class="img-fluid">
                   </div>
                   ...
                   <div class="tour-package__benefits capitalized ">
                       <h3 class="capitalized p-3">your b<span class="underlined">enefit</span>s :</h3>
                        <div class="tour-package__item">
                            <p class="tour-package__item-text">
                               <i><img src="<?php bloginfo('stylesheet_directory') ?>/assets/imgs/icons/check-16.png" alt="" class="inline-icon"></i> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda tempora alias dolor?
                            </p>
                       ...
                       <div class="container-fluid">
                           ...
                           <div class="row d-flex align-items-center text-center">
                               <div class="col-sm-6 col-md-6">
                                   ...
                                   <div class="body">
                                       <span class="underlined">Price : $500</span></div>
                                   </div>
                               <div class="col-sm-6 col-md-6">
                                   <div class="icon">
                           ...
                           <div class="row pb-4 centered">
                               ...
                               <div class="col-12">
                                   <a name="" id="" class="btn btn-primary btn-block" href="#" role="button">book package</a>
                   ...
                   <div class="tour-package__sidebar">
                       <div class="tour-package__help-box sidebar-container mb-3 mt-2">
                           ...
                           <div class="tour-package__help p-3">
                               <h4 class="tour-package__call">
                                   call us now
                               </h4>
                               <i class="fa fa-phone" aria-hidden="true"></i> 
                               <a href="tel:1234567098">+123-456-948</a>
                           </div>
                       </div>
