<?php $jumbo_familia = get_field('jumbo_familia') ;?>
...
<header class="packages-header">
        <div class="jumbotron jumbotron-fluid packages-jumbo rellax" data-rellax-speed="0.3">
            <div class="container">
                <h1 class="display-3 typed-words">jumbo familia.</h1>
           ...
           <div class="row">
               <div class="col-md-9">
                   <div class="tour-package__caption">
                       <h2 class="capitalized pt-3">jumbo familia package.
                   ...
                   <div class="tour-package__description">
                        ...
                        <p> <?php echo $jumbo_familia['description_text'] ;?> </p>
                   </div>

                   <div class="tour-package__banner">
                       <img src="<?php bloginfo('stylesheet_directory') ?>/assets/imgs/jumbo_familia.jpg" alt="" class="img-fluid">
                   </div>
                       ...
                       <h3 class="capitalized p-3">your b<span class="underlined">enefit</span>s :</h3>
                        <div class="tour-package__item">
                            <p class="tour-package__item-text">
                               ...
                               <?php echo $jumbo_familia['first_benefit'] ;?>
                            </p>
                        ...
                        <div class="tour-package__item">
                            <p class="tour-package__item-text">
                                <i><img src="<?php bloginfo('stylesheet_directory') ?>/assets/imgs/icons/check-16.png" alt="" class="inline-icon"></i> 
                                <?php echo $jumbo_familia['second_benefit'] ;?>
                             </p>
                        </div>
                        <div class="tour-package__item">
                            <p class="tour-package__item-text">
                                <i><img src="<?php bloginfo('stylesheet_directory') ?>/assets/imgs/icons/check-16.png" alt="" class="inline-icon"></i> 
                                <?php echo $jumbo_familia['third_benefit'] ;?>
                             </p>
                        </div>
                   </div> -->
                       ...
                       <div class="container-fluid">
                           ...
                           <div class="row d-flex align-items-center text-center">
                               <div class="col-sm-6 col-md-6">
                                   ...
                                   <div class="body">
                                       <span class="underlined">Price : <span class="bold" style="letter-spacing: 2px;">$9,500.00</span></span></div>
                                   </div>
                               <div class="col-sm-6 col-md-6">
                                   <div class="icon">
                           ...
                           <div class="row d-flex align-items-center text-center">
                               ...
                               <div class="col-sm-12 col-md-6">
                                   ...
                                   <div class="body">
                                       <span class="text-center">3 hotel rooms</span>  
                                   </div>
                                </div>
                               <div class="col-sm-12 col-md-6">
                                   <div class="icon">
