<?php $adventurous_family = get_field('adventurous_family') ;?>
...
<header class="packages-header">
        <div class="jumbotron jumbotron-fluid packages-jumbo rellax" data-rellax-speed="0.3">
            <div class="container">
                <h1 class="display-3 typed-words"> Adventurous Family.</h1>
           ...
           <div class="row">
               <div class="col-md-9">
                   <div class="tour-package__caption">
                       <h2 class="capitalized pt-3">adventurous family package.
                   ...
                   <div class="tour-package__description">
                        ...
                        <p><?php echo $adventurous_family['description_text'] ;?></p>
                   </div>

                   <div class="tour-package__banner">
                       <img src="<?php bloginfo('stylesheet_directory') ?>/assets/imgs/adventurous_family.jpg" alt="" class="img-fluid">
                   </div>
                       ...
                       <h3 class="capitalized p-3">your b<span class="underlined">enefit</span>s :</h3>
                        <div class="tour-package__item">
                            <p class="tour-package__item-text"  data-aos="fade-in" data-aos-easing="linear">
                               ...
                               <?php echo $adventurous_family['first_benefit'] ;?>
                            </p>
                       ...
                       <div class="container-fluid">
                           ...
                           <div class="row d-flex align-items-center text-center">
                               <div class="col-sm-6 col-md-6">
                                   ...
                                   <div class="body">
                                       <span class="underlined">Price : <span class="bold" style="letter-spacing: 2px;">$6,200.00</span></span></div>
                                   </div>
                               <div class="col-sm-6 col-md-6">
                                   <div class="icon">
                                       <i><img src="<?php bloginfo('stylesheet_directory') ?>/assets/imgs/icons/triple_customer.png" class="align-bottom"></i>   
                                   </div>
                                   <div class="body">
                                       4 people, 7 days / 6 nights
                                    </div>
                                </div>
                           </div>
                           <div class="row d-flex align-items-center text-center">
                               ...
                               <div class="col-sm-12 col-md-6">
                                   ...
                                   <div class="body">
                                       <span class="text-center">2 hotel rooms</span>  
                                   </div>
                                </div>
                               <div class="col-sm-12 col-md-6">
                                   <div class="icon">
                   ...
                   <div class="tour-package__sidebar">
                       <div class="tour-package__help-box sidebar-container mb-3 mt-2">
                           ...
                           <div class="tour-package__help p-3">
                               ...
                               <a href="tel:1234567098" class="bold" style="letter-spacing: 1.4px; padding-left:5px; font-size:large;" data-aos="fade-out"> +123-456-948</a>
                           </div>
                       </div>
